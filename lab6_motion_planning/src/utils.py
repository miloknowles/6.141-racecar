...
class LineTrajectory(object):
  ...
  def __init__(self, viz_namespace=None):
    ...
    # Publisher for the path that our controller will use.
    self.waypoint_publisher = rospy.Publisher(getParamOrFail('/motion_planning/trajectory_topic'), PolygonStamped, queue_size = 5)
