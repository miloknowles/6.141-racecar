...
from obstacle_avoidance import PlanningLibC as plc
...
class OccupancyGrid(plc.OccupancyGridWrapper):
  ...
  def dynamicUpdate(self, msg, pose_x, pose_y, theta):
    super(OccupancyGrid, self).dynamicUpdateString(self._to_cpp(msg), pose_x, pose_y, theta)
...
class Point2fList(plc.Point2fList):
  pass
